{ config, pkgs, lib, ... }:
{
  ...
  # ========================================================================
  # Noctalia artık nixpkgs unstable'da mevcut.
  # Ayarlar manuel JSON olarak xdg.configFile üzerinden yönetiliyor.
  ...
  programs.noctalia-shell = {
    ...
    systemd.enable = false; # Startup script üzerinden manuel başlatıyoruz
  };

  # ========================================================================
  # NOCTALIA SETTINGS (Manual JSON Generation)
  # ========================================================================
  # 'colorize' ve 'colorKey' değerlerini korumak için doğrudan JSON kullanıyoruz.
  ...
  # WRAPPER SCRIPT
  # ========================================================================
  # Noctalia'nın yazılabilir ayar dosyası ihtiyacı için declarative konfigürasyonu
  # çalışma zamanında geçici bir konuma kopyalıyoruz.
