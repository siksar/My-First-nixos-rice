{ config, pkgs, lib, noctalia, ... }:
{
	...
	programs.noctalia-shell = {
		...
		# Use xdg.configFile to force write settings.json directly.
		# This bypasses potential module serialization issues.
		settings = {}; 
	};
	...
	# ====================================================================
	# Forcefully overwrite settings.json with our desired configuration.
